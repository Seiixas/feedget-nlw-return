...
export function ScreenshotButton({
  ...
  if (screenshot) {
    return (
      <button
        type="button"
        className="p-1 w-10 h-10 rounded-md border-transparent flex justify-end items-end text-zinc-500 dark:text-zinc-400 hover:text-zinc-100 transition-colors"
